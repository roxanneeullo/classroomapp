...
#blocks
  Block.create(name: 'CS1', department_id: 1 ) 
  Block.create(name: 'CS2', department_id: 1  ) 
  Block.create(name: 'CS3', department_id: 1  ) 
  Block.create(name: 'CS4', department_id: 1  ) 
  Block.create(name: 'IT1', department_id: 1  ) 
  Block.create(name: 'IT2', department_id: 1  ) 
  Block.create(name: 'IT3', department_id: 1  ) 
  Block.create(name: 'IT4', department_id: 1  ) 
  Block.create(name: 'NSG1', department_id: 2  ) 
  Block.create(name: 'NSG2', department_id: 2  ) 
  Block.create(name: 'NSG3', department_id: 2  ) 
  Block.create(name: 'NSG4', department_id: 2  ) 
  Block.create(name: 'PT1', department_id: 2  ) 
  Block.create(name: 'PT2', department_id: 2  ) 
  Block.create(name: 'PT3', department_id: 2  ) 
  Block.create(name: 'PT4', department_id: 2  ) 
  Block.create(name: 'ACT1', department_id: 3  ) 
  Block.create(name: 'ACT2', department_id: 3 ) 
  Block.create(name: 'ACT3', department_id: 3 ) 
  Block.create(name: 'ACT4', department_id: 3 ) 
  Block.create(name: 'HRM1', department_id: 3 ) 
  Block.create(name: 'HRM2', department_id: 3 ) 
  Block.create(name: 'HRM3', department_id: 3 ) 
  Block.create(name: 'HRM4', department_id: 3 ) 
